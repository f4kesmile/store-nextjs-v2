...
// Replace avatar with minimal icon-only set to match theme
...
const IconChevronLeft = (props: any) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true" {...props}><path d="M15 19l-7-7 7-7"/></svg>
);
const IconChevronRight = (props: any) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true" {...props}><path d="M9 5l7 7-7 7"/></svg>
);
const IconMenu = (props: any) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true" {...props}><path d="M4 6h16M4 12h16M4 18h16"/></svg>
);
const IconLogout = (props: any) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true" {...props}><path d="M17 16l4-4-4-4"/><path d="M7 12h14"/><path d="M3 21V3h8"/></svg>
);
const IconExternal = (props: any) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true" {...props}><path d="M14 3h7v7"/><path d="M10 14L21 3"/><path d="M5 12v7a2 2 0 002 2h7"/></svg>
);
      ...
      <aside className={cn("bg-white border-r border-border/40 text-foreground transition-all duration-300 fixed h-full z-50 shadow-xl", sidebarOpen ? "w-72" : "w-20", isMobile && "md:relative")}> 
        <div className="p-6 border-b border-border/40">
          <div className="flex items-center justify-between">
            ...
            <Button variant="ghost" size="icon" onClick={() => setSidebarOpen(!sidebarOpen)}><{sidebarOpen ? 'IconChevronLeft' : 'IconChevronRight'} className="w-4 h-4"/></Button>
          </div>
        </div>
