...
const Icons = {
  ...
  products: (p: any) => (
    ...
    >
      <path d="M3 7h18" />
      <path d="M5 7l2 12a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2l2-12" />
...
export default function AdminLayout({
  ...
  return (
    <div
      className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex"
          ...
          <div className="flex items-center justify-between">
            {sidebarOpen && (
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-lg grid place-items-center border bg-brand-soft border-brand-primary">
                  {settings.logoUrl ? (
                    <img
            ...
            >
              {Icons.chevronLeft({
                className: cn("w-4 h-4", !sidebarOpen && "hidden"),
              })}
              {Icons.chevronRight({
                className: cn("w-4 h-4", sidebarOpen && "hidden"),
              })}
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-3">
              ...
              <Button
                asChild
                variant="outline"
                className="gap-2 border-brand-primary/20 hover:bg-brand-soft"
              >
                <Link href="/">
