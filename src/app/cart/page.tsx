                      ...
                      <div className="flex gap-4 flex-1">
                        ...
                        <div className="flex-1 space-y-2">
                          ...
                          <div className="text-lg sm:text-xl font-bold text-brand-primary">
                            Rp {(typeof item.productPrice === 'string' ? 
                              parseFloat(item.productPrice.replace(/[^0-9.]/g, '')) : 
                              item.productPrice
                            ).toLocaleString("id-ID")} × {item.quantity}
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <Input
                            ...
                            onChange={(e) => {
                              ...
                              updateQuantity(item.productId, item.variantId, Math.min(Math.max(1, val), item.maxStock));
                            }}
                          ...
                          <Button
                            variant="outline"
                            size="sm"
                            onClick={() => updateQuantity(item.productId, item.variantId, Math.min(item.maxStock, item.quantity + 1))}
